    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainServiceCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    MainServiceCategoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubCategories_MainServiceCategories_MainServiceCategoryId",
                        column: x => x.MainServiceCategoryId,
                        principalTable: "MainServiceCategories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuestRequests_HotelServiceId",
                table: "GuestRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubCategories_MainServiceCategoryId",
                table: "SubCategories",
                column: "MainServiceCategoryId");
        }
